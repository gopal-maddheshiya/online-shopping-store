...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    searchSuggestions: [
      "Search 'Bail Kolhu Mustard Oil'...",
      "Search 'Jaggery & Sugar (Gud-Chini)'...",
      "Search 'Chaypatti (Tea)'...",
      "Search 'Basmati Rice'...",
      "Search 'Besan & Maida'...",
      "Search 'Jeera & Black Pepper (Marich)'...",
      "Search 'Khade Masale'...",
      "Search 'Pise Masale'...",
      "Search 'Namkeen'...",
      "Search 'Biscuits'...",
  ...
  hi: {
    ...
    purityTagline: "शुद्धता हमारी पहचान",
    puritySub: "आपका विश्वास",
    yourCart: "आपका राशन थैला",
    emptyCartTitle: "आपका थैला खाली है",
    emptyCartSub: "थैले में सामान जोड़ने के लिए खरीदारी शुरू करें।",
    ...
    currentBasketLabel: "थैले का सामान",
    cartAutoFormatNote: "आपके थैले का सामान अपने आप व्यवस्थित होकर व्हाट्सएप संदेश में जुड़ जाएगा।",
    ...
    paymentFailedMessage: "भुगतान पूरा नहीं हो सका या रद्द कर दिया गया। आपका थैला सुरक्षित है, आप पुनः प्रयास कर सकते हैं।",
    ...
    moveAllToCartBtn: "सभी को थैले में जोड़ें",
